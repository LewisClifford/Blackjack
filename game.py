...
if start == "Yes":
    ...
    counter = int(input("How many counters do you want? Max number of counters are 2500"))
    if counter > 2500:
...
while True:
    ...
    if counterplay < 100:
        counterplay = int(input("Can't have less than 100, Re-type the counters you want to play!"))
    ...
    if uanswer == "Hit":
        ...
        if utotal > dtotal:
            print(name, "wins with" ,utotal)
            counter = counter + (counterplay * 2)
        elif dtotal > utotal:
            print("Dealer wins with", dtotal)
            counter = counter - counterplay
    # Double Play
    ...
    TryAgain = input("Do you wanna play again?")
    if TryAgain == "Yes":
        if counter > 100:
            print("Playing again!")
        else:
            print("Cannot play with less than 100 counters!")
            sys.exit()
    else:
        print("Leaving Game")
        exit()
